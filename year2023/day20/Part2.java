...
public class Part2 {
    ...
    public Part2() throws FileNotFoundException {
        File myObj = new File("year2023\\day20\\input.txt");
        ...
        int counter = 1;
        while (true) {
            if (analyzeCircuit(modules, lcms, lcmss, counter)) {
                break;
            }
            counter++;
        }
    ...
    private static boolean analyzeCircuit(ArrayList<Module> modules, ArrayList<Module> lcms, int[] lcmss, int counter) {
