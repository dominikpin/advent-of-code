...
public class Part1 {
    ...
    private static int analyzeString(String line) {
        ...
        int sum = calculateNumberOfWays(damagedSprings, numbers, split[0], 0);
        return sum;
    }
    ...
    private static int calculateNumberOfWays(int damagedSprings, int[] numbers, String springsLine,
            int charIndexToReplace) {
        if (damagedSprings == 0) {
        ...
        int count1 = calculateNumberOfWays(damagedSprings - 1, numbers, modifiedString1, charIndexToReplace + 1);
        int count2 = calculateNumberOfWays(damagedSprings, numbers, modifiedString2, charIndexToReplace + 1);
