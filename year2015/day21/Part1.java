...
public class Part1 {
    ...
    public Part1() throws FileNotFoundException {
        ...
        System.out.println(calculateMostGoldSpent(enemyHp, enemyDamage, enemyArmor));
        myReader.close();
    }

    private static int calculateMostGoldSpent(int enemyHp, int enemyDamage, int enemyArmor) {
